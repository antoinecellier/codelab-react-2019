...
- Mettre à disposition une valeur n'importe ou dans l'arbre de composants
- Pas obligé de faire traversé le context dans l'ensemble de l'arbre
...
- Bibliothèque tierce utilisé: react-router-dom (on a menti)
